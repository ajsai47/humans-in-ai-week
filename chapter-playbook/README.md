...
Everything you need to plan, promote, and execute your Humans in AI Week event.

## Contents

| Document | What it covers |
|----------|---------------|
| [Event Ops Runbook](./event-ops-runbook.md) | Full planning guide from kickoff to post-event |
| [Timeline Checklist](./timeline-checklist.md) | 10-week countdown with weekly milestones |
| [Run of Show Template](./run-of-show-template.md) | Minute-by-minute event schedule template |
| [Post-Event Report](./post-event-report-template.md) | What to submit within 48 hours of your event |
